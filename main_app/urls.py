...
urlpatterns = [
    ...
    path('prescriptions/<int:prescription_id>/remove_dosing/<int:dosing_id>/', views.remove_dosing,
         name='remove_dosing'),
    path('prescriptions/<int:prescription_id>/add_note/', views.add_note, name='add_note'),
    path('prescriptions/<int:prescription_id>/remove_note/<int:note_id>/', views.remove_note, name='remove_note'),
